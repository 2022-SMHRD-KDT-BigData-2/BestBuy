      ...
      <div class="item_List">
         <ul class="row">
            <li>
               <div class="best_item">
                  <h3>내상품리스트</h3>
               </div> <input type="hidden" name="p_num" value="${vo.p_num}" />
            </li>
            ...
            <table>
               ...
               <tr>
                  <td>${list[0].p_name}</td>
                  <td>${list[0].p_kind}</td>
                  <td>${list[0].p_weight}</td>
                  <td>${list[0].p_grade}</td>
                  <td>${list[0].p_price}</td>
                  <td>${list[0].p_data}</td>
                  <td>${list[0].p_sweet}</td>
                  <td>${list[0].p_pack}</td>
               </tr>
            ...
            <a href="<c:url value='/myproductUpdate.do/${list[0].p_num}'/>" role="button">수정</a>
            <a href="<c:url value='/myproductDelete.do/${list[0].p_num}'/>" role="button">삭제</a>
